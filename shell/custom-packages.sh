...
CUSTOM_PACKAGES="$CUSTOM_PACKAGES qmodem"
CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-app-qmodem"
CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-app-qmodem-sms"
CUSTOM_PACKAGES="$CUSTOM_PACKAGES ubus-at-daemon"
CUSTOM_PACKAGES="$CUSTOM_PACKAGES quectel-CM-5G-M"
CUSTOM_PACKAGES="$CUSTOM_PACKAGES sms-forwarder"
CUSTOM_PACKAGES="$CUSTOM_PACKAGES sms-tool_q"
CUSTOM_PACKAGES="$CUSTOM_PACKAGES tom_modem"
CUSTOM_PACKAGES="$CUSTOM_PACKAGES ndisc6"
CUSTOM_PACKAGES="$CUSTOM_PACKAGES rdisc6"
